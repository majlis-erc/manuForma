                            ...
                            <xf:switch id="edit" class="mainContent panel">
                                <xf:case id="view-main-entry" selected="true()">
                                    ...
                                    <div class="fileLoading">
                                        ...
                                        <div class="input-group mb-3">
                                            <xf:select1 xmlns="http://www.w3.org/2002/xforms" class="form-control" ref="instance('i-selected-search')">
                                                <xf:label/>
            ...
            <body>  
                <h2 class="h3 mainElement"><xsl:value-of select="$subform/@formLabel"/></h2>
                    ...
                    <xsl:for-each select="$subsequence/element()">
                        ...
                        <xsl:variable name="childRepeatID">repeat-level1</xsl:variable>
                        <!-- Build XForm element -->
                        <xf:group namespace="http://www.w3.org/2002/xforms" ref="instance('i-rec')/{$elementPath}">
    ...
    <xsl:template name="xformElementUI">
        ...
        <div class="btn-toolbar justify-content-between mt-3 elementControls" role="toolbar">
                    ...
                    <xf:trigger xmlns="http://www.w3.org/2002/xforms" appearance="minimal" class="btn controls moveUp inline">
                        ...
                        <xf:action ev:event="DOMActivate">
                            ...
                            <xsl:element name="insert" namespace="http://www.w3.org/2002/xforms">
                                <xsl:attribute name="origin">instance('i-rec')/<xsl:value-of select="$xpath"/>[index('<xsl:value-of select="$repeatID"/>')]</xsl:attribute>
                                <xsl:attribute name="nodeset">instance('i-rec')/<xsl:value-of select="$xpath"/></xsl:attribute>
                            ...
                            <xsl:element name="delete" namespace="http://www.w3.org/2002/xforms">
                                <xsl:attribute name="nodeset">instance('i-rec')/<xsl:value-of select="$xpath"/>[instance('i-move')/tmp + 1]</xsl:attribute>
                            </xsl:element>
                        </xf:action>
                    </xf:trigger>
            ...
            <div class="input-group">
                <xf:select1 xmlns="http://www.w3.org/2002/xforms" ref="instance('i-availableElements')/*[local-name() = local-name(current())][instance('i-schemaConstraints')/*[local-name() = local-name(current())]/tei:availableAtts/descendant-or-self::tei:attDef]">
                    <xf:label/>
                    <xf:itemset ref="instance('i-schemaConstraints')/*[local-name() = local-name(current())]/tei:availableAtts/descendant-or-self::tei:attDef">
                        <xf:label ref="@ident"/>
                        <xf:value ref="@ident"/>
                    </xf:itemset>
                    <xf:action ev:event="xforms-value-changed">
                        <xf:setvalue ref="instance('i-insert-attributes')//tei:attribute" value="instance('i-availableElements')/*[local-name() = local-name(current())]"/>
                    </xf:action>
                </xf:select1>
                <xf:trigger class="btn btn-outline-secondary btn-sm controls add" appearance="full" ref=".[instance('i-availableElements')/*[local-name() = local-name(current())][instance('i-schemaConstraints')/*[local-name() = local-name(current())]/tei:availableAtts/descendant-or-self::tei:attDef]]">
                    <xf:label><i class="bi bi-plus-circle"/> Add Attribute</xf:label>
                    <xf:insert ev:event="DOMActivate" context=".[not(name(@*) = instance('i-insert-attributes')//tei:attribute)]" origin="instance('i-attributeTemplate')//@*[name(.) = instance('i-insert-attributes')//tei:attribute]" position="after"/>
                </xf:trigger> 
                <xf:select1 xmlns="http://www.w3.org/2002/xforms" ref="instance('i-availableElements')/*[local-name() = local-name(current())][instance('i-schemaConstraints')/*[local-name() = local-name(current())]/tei:childElements[1]/tei:child/tei:element]">
                    <xf:label/>
                    <xf:item>
                        <xf:label> - select - </xf:label>
                        <xf:value/>
                    </xf:item>
                    <xf:itemset ref="instance('i-schemaConstraints')/*[local-name() = local-name(current())]/tei:childElements[1]/tei:child/tei:element">
                        <xf:label ref="@ident"/>
                        <xf:value ref="@ident"/>
                    </xf:itemset>
                    <xf:action ev:event="xforms-value-changed">                            
                        <xf:setvalue ref="instance('i-insert-elements')//tei:element" value="instance('i-availableElements')/*[local-name() = local-name(current())]"/>
                    </xf:action>
                </xf:select1>
                <xf:trigger class="btn btn-outline-secondary btn-sm controls add" appearance="full" ref=".[instance('i-availableElements')/*[local-name() = local-name(current())][instance('i-schemaConstraints')/*[local-name() = local-name(current())]/tei:childElements[1]/tei:child/tei:element]]">
                    <xf:label><i class="bi bi-plus-circle"/> Add Element</xf:label>
                    <xf:insert ev:event="DOMActivate" context="." at="." origin="instance('i-elementTemplate')//*[local-name() = instance('i-insert-elements')//tei:element]" position="after"/>
                </xf:trigger>
            </div>
        </div>
        <div class="element">   
            <div class="alert alert-light hint elementDesc">
                <xf:output ref="instance('i-schemaConstraints')/*[local-name() = local-name(current())]/tei:desc"/>                    
            </div>
            <span class="attribute-group">
                <xf:repeat xmlns="http://www.w3.org/2002/xforms" ref="@*" class="row mb-2">
                    <div xmlns="http://www.w3.org/1999/xhtml" class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <xf:input ref=".[not(instance('i-schemaConstraints')/child::*/tei:availableAtts/tei:attDef[@ident = name(current())]/descendant::tei:valList/tei:valItem)]"/>
                            <xf:select1 ref=".[instance('i-schemaConstraints')/child::*/tei:availableAtts/tei:attDef[@ident = name(current())]/descendant::tei:valList/tei:valItem]">
                                <xf:itemset ref="instance('i-schemaConstraints')/child::*/tei:availableAtts/tei:attDef[@ident = name(current())]/descendant::tei:valList/tei:valItem">
                                    <xf:label ref="@ident"/>
                                    <xf:value ref="@ident"/>
                                </xf:itemset>
                            </xf:select1>
            ...
            <span class="element-group">                        
                <xf:input ref=".[instance('i-schemaConstraints')/*[local-name() = local-name(current())]/tei:childElements/tei:textNode[@type='input']]"/>
                <xf:textarea ref=".[instance('i-schemaConstraints')/*[local-name() = local-name(current())]/tei:childElements/tei:textNode[@type='textarea']]"/>  
                <xsl:if test="$currentLevel &lt;= $maxLevel">
                    ...
                    <xf:repeat ref="./*[instance('i-schemaConstraints')/*[local-name() = local-name(current())]/tei:childElements/tei:child]">
                        <xsl:call-template name="xformElementUI">
